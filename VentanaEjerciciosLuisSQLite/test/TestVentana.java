...
public class TestVentana {
    ...
    // public void hello() {}
    @Test
    public void pruebaInsercioPersonaYLoComprobamosConElTamanioDelVector() throws IOException, FileNotFoundException, ClassNotFoundException{
    ...
    @Test
    public void pruebaInsercionCorrectaPersona() throws IOException, FileNotFoundException, ClassNotFoundException{
    ...
    public void pruebaInsercioGrupoYLoComprobamosConElTamanioDelVector() throws IOException, FileNotFoundException, ClassNotFoundException{
        ...
        ventana.crearNuevoGrupo("grupo", "director", 10, "horario", "persona");
        int result1 = 1;
